...
interface UToolsApi {
     ...
     * @param options 参考 {@link https://www.electronjs.org/docs/api/browser-window#new-browserwindowoptions}
    ...
    createBrowserWindow(url: string, options: {
        ...
        height?: number,
        [key: string]: any
    }, callback?: () => void): { id: number, webContents: { id: number, [key: string]: any }, [key: string]: any };
     ...
     */
    openPurchase(options: PurchaseOption, callback?: () => void): void;
     ...
     */
    openPayment(options: PurchaseOption, callback?: () => void): void;

    /**
     * 获取用户支付记录
     */
    fetchUserPayments(): Promise<Array<UserPayment>>;
     ...
     * 设置 ubrowser 代理
     *
     * @see https://www.electronjs.org/docs/api/session#sessetproxyconfig
     */
